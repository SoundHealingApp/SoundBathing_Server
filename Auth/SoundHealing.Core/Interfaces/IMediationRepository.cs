...
public interface IMediationRepository
{
    ...
    public Task DeleteAsync(Meditation meditation, CancellationToken cancellationToken);
    
    public Task<bool> IsExistsAsync(string title, CancellationToken cancellationToken);

    public Task<List<Meditation>?> GetByTypeAsync(MeditationType meditationType, CancellationToken cancellationToken);

    public Task<Meditation?> GetByIdAsync(Guid meditationId, CancellationToken cancellationToken);
