...
{
    /// <inheritdoc />
    public partial class changedRecommendedMeditationsName : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "UserRecommendedMeditations",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserRecommendedMeditations", x => new { x.MeditationId, x.UserId });
                    table.ForeignKey(
                        name: "FK_UserRecommendedMeditations_Meditations_MeditationId",
                        column: x => x.MeditationId,
                        principalTable: "Meditations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserRecommendedMeditations_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserRecommendedMeditations_UserId",
                table: "UserRecommendedMeditations",
                column: "UserId");
        }
